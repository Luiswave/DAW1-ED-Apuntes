...
Los drivers son controladores de los dispositivos.
...
La CPU se llama tambien UCP (en ingles), procesador o microprocesador
...
Solo valido para **lenguajes compilados: C, C++, Java**.

En lenguajes interpretados no existe codigo objeto, ni binario. Solo codigo fuente. Por ejemplo: PHP, Javascript, ...
